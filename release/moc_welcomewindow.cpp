...
QT_MOC_LITERAL(1, 14, 35), // "openChooseSatellitesWindowReq..."
QT_MOC_LITERAL(2, 50, 0), // ""
QT_MOC_LITERAL(3, 51, 35), // "on_btnOpenWindowChooseGroup_c..."
QT_MOC_LITERAL(4, 87, 12), // "ShowTableSat"
QT_MOC_LITERAL(5, 100, 13) // "ShowTableStan"

    },
    "WelcomeWindow\0openChooseSatellitesWindowRequested\0"
    "\0on_btnOpenWindowChooseGroup_clicked\0"
    "ShowTableSat\0ShowTableStan"
};
...
void WelcomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->openChooseSatellitesWindowRequested(); break;
        case 1: _t->on_btnOpenWindowChooseGroup_clicked(); break;
        case 2: _t->ShowTableSat((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->ShowTableStan((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomeWindow::openChooseSatellitesWindowRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WelcomeWindow::openChooseSatellitesWindowRequested()
{
