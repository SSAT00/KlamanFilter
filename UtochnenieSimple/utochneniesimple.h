#ifndef UTOCHNENIESIMPLE_H
#define UTOCHNENIESIMPLE_H
...
public:
    ...
    void Observate();
    void WriteObsSat(int);
    bool ObsInBlock(int, int);

    QVector<double> RefineSat(int);
    void Refine();
    ...
    void UnNormalizeDq(int, Matrix<long double, Dynamic, 1>&);

    void WriteFile(int);
    void WriteStanCoords();
...
//signals:
//    void WriteConsoleSignal();

};

#endif // UTOCHNENIESIMPLE_H
